...
import { disableUserFromReport, listReports, resolveReport, submitReport, unblockUserFromReport, warnUserFromReport } from './controller';
...
router.post('/actions/resolve', authenticate, authorizeRoles(ROLES.ADMIN), resolveReport);
